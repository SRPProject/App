...
const fileValidator = async (value, { req }) => {
...
const addDetailsValidator = async (req, res, next) => {
  ...
  await body("community").notEmpty().withMessage("community invalid").run(req);

  await body("volunteer").notEmpty().withMessage("volunteer invalid").run(req);
  ...
  await body("fatherjob").notEmpty().withMessage("fatherjob invalid").run(req);
  ...
  await body("motherjob").notEmpty().withMessage("motherjob invalid").run(req);
